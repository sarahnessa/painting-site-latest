...
export default function Contact(): import("react").JSX.Element {
  ...
  const inputClass =
    "w-full px-5 py-4 rounded-2xl outline-none transition-colors";
  ...
  const social_links = {
    Instagram: "https://www.instagram.com/sarahnessaart",
    Pinterest: "#",
  };
  ...
  return (
    <>
      <Helmet>
        <title>Contact | Sarah Nessa Oil Painter</title>
        <meta
          name="description"
          content="Contact information and fill out the contact form to get in touch."
        />
        <meta property="og:title" content="Contact | Sarah Nessa Oil Painter" />
        ...
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6">
            ...
            <p
              ...
              style={{ color: "#3D3B52" }}
            >
              Questions about a painting, auction, shipping, commission
              inquiries, or just to say hello — all messages are read and
              answered personally, usually within a couple of days.
            </p>
          </div>
        </section>
          ...
          <div className="md:col-span-2 space-y-10">
                ...
                {contactDetails.map((item) => (
                  <div key={item.label} className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-base" style={{ color: "#1C1B2E" }}>
                        {item.value}
                      </p>
                    </div>
                  </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                {Object.entries(social_links).map(([platform, src]) => {
                  return (
                    <div
                      key={platform}
                    ...
                    >
                      <a href={src} target="_blank">{platform}</a>
                    </div>
                  );
                })}
              </div>
          ...
          <div className="md:col-span-3">
            {sent ? (
              ...
              >
                ...
                <h3
                  className="font-display text-2xl mt-6 mb-3"
                  style={{ color: "#1C1B2E" }}
                >
                  Message sent!
                </h3>
                <p
                  ...
                  style={{ color: "#6B6880" }}
                >
                  Thank you for reaching out. I'll read your message personally
                  and get back to you within a few days from the studio.
                </p>
                <button
              ...
              >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={inputClass}
                    style={{
                      ...(focused === "message" ? inputFocused : inputBase),
                      resize: "none",
                    }}
