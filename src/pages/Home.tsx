...
const homepagePaintings = [
  {
    ...
    alt: "The Lucid Ones oil painting",
    series: "Nature × Spirit",
  },
  {
    url: mitosis,
    title: "Cellular Reproduction",
    alt: "Cellular Reproduction oil painting",
    series: "Science × Art",
  },
  {
    url: joshua,
    title: "The Joshua Hour",
    alt: "The Joshua Hour oil painting",
    series: "Travel Gems",
  },
  {
    url: pollen,
    title: "Pollinator",
    alt: "Pollinator oil painting",
    series: "Science × Art",
  },
  {
    url: gingko,
    title: "Looking for Light Gingko",
    alt: "Looking for Light Gingko oil painting",
    series: "Nature × Spirit",
  },
];
...
export default function Home({
  onNav,
}: HomeProps): import("react").JSX.Element {
  ...
  return (
    <>
      <Helmet>
        <title>Home | Sarah Nessa Oil Painter</title>
        <meta
          name="description"
          content="Sarah Nessa Oil Painter - Hand-painted original oil on canvas, featured as an upcoming auction."
        />
        <meta property="og:title" content="Home | Sarah Nessa Oil Painter" />
      ...
      <div className="min-h-screen" style={{ backgroundColor: "#FAFAFA" }}>
        ...
        <section className="relative max-w-7xl mx-auto px-6 pt-32 pb-24 grid grid-cols-1 md:grid-cols-2 gap-16 items-center overflow-hidden">
          ...
          <div
            className="blob-a absolute bottom-24 right-1/4 pointer-events-none"
          ...
          <div className="relative flex flex-col items-center md:items-start">
            <div className="relative">
              <div
                ...
                style={{
                  background:
                    "conic-gradient(from 0deg, #FFD15C, #F5F271, #FF4D6D, #818CF8, #FFD15C)",
                  filter: "blur(10px)",
                  opacity: 0.55,
                }}
              />
          ...
          <div className="relative z-10">
            ...
            <p
              ...
              style={{ color: "#3D3B52" }}
            >
              I paint what attention feels like — the specific quality of light
              on a forest floor, the uncanny geometry of a cell, the emotional
              residue of a place long after the trip is over.
            </p>
            <p
              className="text-base leading-relaxed mb-8"
              style={{ color: "#6B6880" }}
            >
              Based out of a north-facing studio in San Francisco, California, I
              work exclusively in oil on canvas, building surfaces slowly over
              weeks — glazing, scraping, returning. My three ongoing series each
              explore a different conversation: nature and spirit, science and
              art, and the gem-like places travel has given me.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <button
                  key={s.page}
                  // Disabled Series button clicks -- Uncomment second onClick attribute to enable
                  disabled={isDisabled}
                  onClick={handleClick}
            ...
            {homepagePaintings.map((p, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(28,27,46,0.78) 0%, transparent 60%)",
                  }}
                >
                  <p className="bottom-4 left-4 hidden md:block text-sm font-display text-white md:text-lg leading-tight">
                    {p.title}
                  </p>
                  <p
                    className="bottom-4 left-4 hidden md:block text-xs mt-1 md:text-sm"
                    style={{ color: "#FFD15C" }}
                  >
                    {p.series}
                  </p>
